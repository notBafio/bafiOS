...
pub static mut TEMP_FILE: crate::fat16::structs::Entry = crate::fat16::structs::NULL_ENTRY;
    ...
    unsafe {
        ...
        match eax {
            ...
            2 => {
                ...
                if let Some(entry) = (*(&raw mut crate::fat16::structs::FAT16))
                    .find_entry(&format_path_8_3(filename))
                {
                    (*(&raw mut crate::fat16::structs::FAT16)).read(&entry, ecx as *mut u8);
                    return_val = 1;
                }
            }
            ...
            28 => {
                ...
                let n_entries = (*(&raw mut crate::fat16::structs::FAT16)).count_entries_in_dir(
                    core::str::from_utf8_unchecked(&fname[..core::cmp::min(edx as usize, 256)]),
                );
            ...
            29 => {
                ...
                let mut n_entries = (*(&raw mut crate::fat16::structs::FAT16)).get_entries_by_id(
                    core::str::from_utf8_unchecked(&fname[..core::cmp::min(edx as usize, 256)]),
                    ecx as u8,
                );

                if n_entries.is_some() {
                    let e_size = core::mem::size_of::<crate::fat16::structs::Entry>() as u32;

                    let addr = (*(&raw mut crate::pmm::PADDR)).malloc(e_size).unwrap();

                    *(addr as *mut crate::fat16::structs::Entry) = n_entries.unwrap();
            ...
            38 => {
                ...
                if let Some(_entry) = (*(&raw mut crate::fat16::structs::FAT16))
                    .find_entry(&format_path_8_3(filename))
                {
                    ...
                    let _ = (*(&raw mut crate::fat16::structs::FAT16))
